    ...
    >
      ...
      <View style={styles.inputWrapper}>
        ...
        <TouchableOpacity onPress={() => setMostrarPassword(!mostrarPassword)} style={styles.eyeBtn}>
          <Ionicons name={mostrarPassword ? 'eye-off' : 'eye'} size={20} color={theme.colors.gray} />
        </TouchableOpacity>
      </View>
...
const styles = StyleSheet.create({
  ...
  inputWrapper: { flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: theme.colors.lightGray, borderRadius: 8, backgroundColor: theme.colors.card, marginBottom: 4 },
  inputFlex: { flex: 1, padding: 14, fontSize: 15, color: theme.colors.white },
